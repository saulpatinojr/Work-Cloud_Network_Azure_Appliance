...
variable "api_token" {
  description = "Bearer token cna-web presents to the internal cna-api (SEC-001/ARCH-002). Generated by the workload root (random_password) and stored in Key Vault as cna-api-token; injected into both the api and web containers as CNA_API_TOKEN."
  type        = string
  sensitive   = true
}
